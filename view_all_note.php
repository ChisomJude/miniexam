    ...
    <div class="row">
        ...
        <form action=""  enctype="multipart/form-data" method="Post">
         <div class="input-group form-control">
            ...
            //$id = $_SESSION['id'];
            $result1 = mysqli_query($con,"SELECT * FROM courses") or die('Error');
         ...
         <div class="col-md-8">';
          if($_POST['submit']){
              ...
              $result = mysqli_query($con, "SELECT * FROM courses INNER JOIN class 
                ON courses.class_id = class.id WHERE courses.course_id = '$idd'") or die('Error');     
            ...
            $result = mysqli_query($con, "SELECT * FROM note WHERE cos_id = '$idd' ") or die('Error');
            ...
            while ($row = mysqli_fetch_array($result)) {
                ...
                <td style="vertical-align:middle"><a href="dash.php?q=20&n='.$id.'">View</a></td><td style="vertical-align:middle"><a title="Delete Note" href="view_all_note.php?id=' . $id . '"><b><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></b></a></td></tr>';
            }
            $c = 0;
            echo '</table></div>';
          }else {
