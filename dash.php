...
?>><a href="dash.php?q=1">Students</a></li>
 ...
 <li class="dropdown <?php if(@$_GET['q']==9 || @$_GET['q']==10) echo'active"'; ?>">
          ...
          <ul class="dropdown-menu">
            <li><a href="dash.php?q=9">Add Subject</a></li>
            <li><a href="dash.php?q=10">View/Remove Subject</a></li>
             <li><a href="dash.php?q=13">Assign Subject To Teacher</a></li>
             <li><a href="dash.php?q=14">View Assign Subjects</a></li>
          </ul>
        </li>
 <!-- ends here-->
  <!-- Best added this for class-->
 <li class="dropdown <?php if(@$_GET['q']==11 || @$_GET['q']==12) echo'active"'; ?>">
          ...
          <ul class="dropdown-menu">
            <li><a href="dash.php?q=11">Add Class</a></li>
            <li><a href="dash.php?q=12">View/Remove Class</a></li>
 ...
 <li class="dropdown <?php if(@$_GET['q']==7 || @$_GET['q']==8) echo'active"'; ?>">
          ...
          <ul class="dropdown-menu">
            <li><a href="dash.php?q=7">Add Teachers</a></li>
            <li><a href="dash.php?q=8">View/Remove Teachers</a></li>
...
if (@$_GET['q'] == 6)
    echo 'class="active"';
?>><a href="dash.php?q=6">Add Students</a></li>
    <li <?php
if (@$_GET['q'] == 2)
    echo 'class="active"';
?>><a href="dash.php?q=2">Results</a></li>
    <li <?php
if (@$_GET['q'] == 3)
    echo 'class="active"';
...
if (@$_GET['q'] == 20)
    echo 'class="active"';
?>><a href="dash.php?q=20">Notes</a></li>
      </ul>
          </div>
  </div>
</nav>
...
<tr><td style="vertical-align:middle"><b>Rank</b></td><td style="vertical-align:middle"><b>Name</b></td><td style="vertical-align:middle"><b>Branch</b></td><td style="vertical-align:middle"><b>Username</b></td><td style="vertical-align:middle"><b>Roll number</b></td><td style="vertical-align:middle"><b>Gender</b></td><td style="vertical-align:middle"><b>Score</b></td></tr>';
    ...
    if($total >= $showfrom){
        ...
        while ($row = mysqli_fetch_array($q)) {
            $e = $row['examno'];
            $s = $row['score'];
            $q12 = mysqli_query($con, "SELECT * FROM user WHERE rollno='$e' ") or die('Error231');
...
//$pname = $_POST['p_name'];
$phno = $_POST['p_contact'];
//$addr = $_POST['addr'];
//$nextk = $_POST['nextK'];
//$illness = $_POST['illness'];
//$illD = $_POST['ill_details'];
$username= "BFS".rand(1010,8009);
$qq= mysqli_query($con ,"SELECT * FROM class WHERE id= '$class'");
$fetch= mysqli_fetch_array($qq);
$className =$fetch['class_name'];
$Q= "INSERT INTO user VALUES (NULL, '$name', '$username', '$className', '$gender' ,  '$phno', '$username','$class' )";

$q3=mysqli_query($con,$Q);
if($q3)
{
$id= mysqli_insert_id($con);
$qq= mysqli_query($con ,"SELECT * FROM user WHERE id= '$id'");
if($qq){
  $fetch= mysqli_fetch_array($qq);
  $name= $fetch['name'];
  $exam_no= $fetch['rollno'];
  $class= $fetch['branch'];
  @$msg= "<div style='color:green';><h3> Record Inserted Successfull!</h3><br/>
        <h5>Name: ". $name ."</h5>
        <h5>Exam NO: ". $exam_no  ."</h5>
        <h5>Class: ".$class . "</h5>
  </div>";
}
}
...
<fieldset>
    <br>';
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="name" placeholder="Surname First" class="form-control input-sm" required>
                            </div>
                            <br>
                            <div class="input-group col-md-12 form-control">
                                ...
                                <div class="input-group col-md-12 form-control">
                                 <label form-group>
                                    <input type="radio" name="sex" class="minimal" value="M" >
                                    <i class="fa fa-male" ></i>Male
                                </label>&nbsp;&nbsp;&nbsp;&nbsp;
                                <label>
                                    <input type="radio" name="sex" class="minimal" value="F" >
                            ...
                            <br>    
                            <div class="input-group">
                                <span class="input-group-addon">Parents/Guardian Contact</span>
                                <input type="text" name="p_contact" placeholder="Enter Parents Contact" class="form-control input-sm" >
                            </div>
                            <br>
                            
                            <div class="form-group col-md-6 pull-right">
                                <input type="submit" class="btn btn-primary btn-block" name="register" value="Register Student" >
                            </div>
                        </form>
</fieldset>
</form></div></div>';
...
<span class="title1" style="margin-left:40%;font-size:30px;"><b>Enter Teacher\'s Details</b></span><br /><br />
 <div class="col-md-3"></div><div class="col-md-6">   <form class="form-horizontal title1" name="form" action=""  method="POST">
<div class="col-md-10 col-md-offset-1" style="border:4px; border-raduis:4px solid #456455;">';
if($_POST['register']){
$name = $_POST['name'];
...
$username= "BFT".rand(1010,8009);

$Q= "INSERT INTO teachers VALUES (NULL, '$name', '$username', '$password' )";

$q3=mysqli_query($con,$Q);
if($q3)
{
$id= mysqli_insert_id($con);
$qq= mysqli_query($con ,"SELECT * FROM teachers WHERE id= '$id'");
if($qq){
  $fetch= mysqli_fetch_array($qq);
  $name= $fetch['name'];
  ...
  @$msg= "<div style='color:green';><h3> Record Inserted Successfull!</h3><br/>
        ...
        <h5>Password: ".$password . "</h5>
         <h5>Please copy down these details</h5>
  </div>";
}
}
else
    ...
    <br>';
                            ...
                            <br>
                             <div class="input-group">
                                ...
                                <input type="text" name="password" placeholder="Password" class="form-control input-sm" required>
                            </div>
                            <br>
                               <div class="form-group col-md-6 pull-right">
                                <input type="submit" class="btn btn-primary btn-block" name="register" value="Register Teacher" >
                            </div>
                        </form>
</fieldset>
</form></div></div>';
...
if (@$_GET['q'] == 8) {
     require_once 'view_teachers.php';
}
if(@$_GET['q'] == 11){
    require_once 'addClass.php';
}
if(@$_GET['q'] == 12){
    require_once 'view_remove_class.php';
}
if (@$_GET['q'] == 9) {
...
if (@$_GET['q'] == 13) {
    require_once 'assign_subject.php';
}
if (@$_GET['q'] == 14) {
    require_once 'view_assign_subject.php';
}
if (@$_GET['q'] == 20 && !isset($_GET['n']) ){
    require_once 'view_all_note.php';
}
 if (@$_GET['q'] == 20 && isset($_GET['n'])){
    $id = $_GET['n'];
