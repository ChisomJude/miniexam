         ...
         <div class="col-md-8">';
          if($_POST['submit']){
            ...
            while ($row = mysqli_fetch_array($result)) {
                ...
                <td style="vertical-align:middle"><a href="dashboard_teacher.php?q=2&n='.$id.'">View</a></td><td style="vertical-align:middle"><a title="Delete Note" href="teacher_view_note.php?id=' . $id . '"><b><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></b></a></td></tr>';
            }
            $c = 0;
            echo '</table></div>';
          }else {
